...
function Layout({ children }) {
    ...
    function setMenuItemCommand(item) {
        ...
        console.log("originalCommand: ", originalCommand);
    ...
    useEffect(() => {
        ...
        const fetchSidebarMenu = async () => {
            ...
            for(let i = 0; i < sidebar_menu_schema.length; i++) {
                ...
                // console.log("originalCommand: ", originalCommand);
                // console.log("sidebar_menu_schema[i]: ", menuItem);                        

                setMenuItemCommand(menuItem);

            }
            console.log("sidebar_menu_schema: ", sidebar_menu_schema);
            // const callback = sidebar_menu_schema[0].items[0].command
            // sidebar_menu_schema[0].items[0].command =     (e)=>     callback(e, 'nurym', router)

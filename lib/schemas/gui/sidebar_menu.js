...
export const sidebar_menu_schema = [
    {
        ...
        items: [
            ...
            {
                label: "ETL Process Config",
                icon: "pi pi-fw pi-list-check",
                command: (e, router, setChildEntityName) => {
                    setChildEntityName("meta_EtlProcessConfig");
                }
            },
            {
                label: "ETL Process Types",
                icon: "pi pi-fw pi-list",
                command: (e, router, setChildEntityName) => {
                    console.log("ETL Process Types command");
                    setChildEntityName("meta_EtlProcessType");
                },
            },
            {
                ...
                icon: "pi pi-fw pi-list",
                command: (e, router, setChildEntityName) => {
                    setChildEntityName("meta_EtlProcessJournal");
                }
            },
            {
